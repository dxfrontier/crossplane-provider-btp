...
type SubaccountInitParameters struct {
	...
	// +crossplane:generate:reference:refFieldName=ParentRef
	// +crossplane:generate:reference:selectorFieldName=ParentSelector
	ParentID *string `json:"parentId,omitempty" tf:"parent_id,omitempty"`

	// Reference to a Directory in account to populate parentId.
	// +kubebuilder:validation:Optional
	ParentRef *v1.Reference `json:"parentRef,omitempty" tf:"-"`

	// Selector for a Directory in account to populate parentId.
	// +kubebuilder:validation:Optional
...
// Subaccount is the Schema for the Subaccounts API. Creates a subaccount in a global account or directory. Tip: You must be assigned admin role of the global account or directory. Further documentation: https://help.sap.com/docs/btp/sap-business-technology-platform/account-model
